...
.hero{margin:0 0 24px;display:none}  /* PDF/print-only cover section — hidden on the live dashboard */
...
@media print{
  ...
  *{-webkit-print-color-adjust:exact !important;print-color-adjust:exact !important}
  ...
  .hero{display:block !important;margin-bottom:10px;break-inside:avoid}
  ...
  /* fill the page: single full-width charts get the most room, paired charts share a row */
  #exphist,#techStack{height:600px !important}
  #verticals,#qual,#deptRaw,#lang,#sectors,#topEmp,#techDept,#techExp,#phdDomain,#phdSpec{height:540px !important}
}
</style>
</head>
<body>
